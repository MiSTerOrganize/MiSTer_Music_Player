//============================================================================
//
//  Music Player Native Video Top-Level Wrapper
//
//  320x240 native video output via DDR3.
//  ARM renders UI (waveform, track info) to RGB565 in DDR3.
//  FPGA reads and outputs through MiSTer's video pipeline.
//
//  Adapted from PICO-8 pico8_video_top.sv
